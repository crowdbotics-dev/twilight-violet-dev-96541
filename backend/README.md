...
## Project Structure
    ...
    ├── twilight_violet_dev_96541  # Django project configurations
...
1. Clone this repo and `cd twilight_violet_dev_96541`
...
2. Clone this repo and `cd twilight_violet_dev_96541`
